...
public class CreateMesh : MonoBehaviour
{
    ...
    private void InitMesh()
    {
        ...
        {
            new Vector3(1* vertProgress + OffsetX,1+ OffsetY,0), //右上 0
            new Vector3(1* vertProgress+ OffsetX,-1+ OffsetY,0), //右下 1
        ...
        Vector2[] uv = new Vector2[4]{
            new Vector2(1.0f * progress, 1),
            new Vector2(1.0f * progress, 0),
            new Vector2(0, 0),
            new Vector2(0, 1)
        };
        _mesh.uv = uv;
