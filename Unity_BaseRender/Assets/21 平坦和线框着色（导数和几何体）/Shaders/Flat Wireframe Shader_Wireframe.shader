...
//	#define PARALLAX_RAYMARCHING_SEARCH_STEPS 3
	...
	SubShader {
		...
		Pass {
			...
			//要实际使用几何着色器，我们必须添加#pragma geometry指令
		...
		Pass {
			...
			#include "My Shadows_Wireframe.cginc"
		...
		Pass {
			...
			#include "My Lightmapping_Wireframe.cginc"

			ENDCG
		}
	}

	CustomEditor "MyLightingShaderGUI_Wireframe"
}