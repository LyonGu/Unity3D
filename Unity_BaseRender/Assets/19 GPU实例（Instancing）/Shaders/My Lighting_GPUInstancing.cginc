...
#if !defined(MY_LIGHTING_INCLUDED_GPUInstancing)
#define MY_LIGHTING_INCLUDED_GPUInstancing
...
struct VertexData {
	UNITY_VERTEX_INPUT_INSTANCE_ID  //GPUInstancing 实例相对应的数组索引 启用实例化后，我们现在可以在顶点程序中访问实例ID
