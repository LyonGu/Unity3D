...
//	#define PARALLAX_RAYMARCHING_SEARCH_STEPS 3
	...
	SubShader {
		...
		Pass {
			...
			#include "MyFlatWireframe_Tessellation.cginc"
		...
		Pass {
			...
			#include "My Shadows_Tessellation.cginc"
		...
		Pass {
			...
			#include "My Lightmapping_Tessellation.cginc"

			ENDCG
		}
	}

	CustomEditor "MyLightingShaderGUI_Tessellation"
}