#if !defined(MY_LIGHTING_INCLUDED_MixingLight)
#define MY_LIGHTING_INCLUDED_MixingLight
...
Interpolators MyVertexProgram (VertexData v) {
	...
	UNITY_TRANSFER_SHADOW(i, v.uv1); //使用新的宏 需要先使用UNITY_INITIALIZE_OUTPUT宏来初始化对应的插值器
...
float FadeShadows (Interpolators i, float attenuation) {
		...
		//采样阴影遮罩 UnitySampleBakedOcclusion
...
UnityLight CreateLight (Interpolators i) {
	UnityLight light;
		...
		attenuation = FadeShadows(i, attenuation); //使用UNITY_LIGHT_ATTENUATION之后必须完成此手动淡出
