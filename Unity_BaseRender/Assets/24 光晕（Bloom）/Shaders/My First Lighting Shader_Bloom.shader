Shader "Custom/My First Lighting Shader_Bloom" {
...
//	#define PARALLAX_RAYMARCHING_SEARCH_STEPS 3
	...
	SubShader {
		...
		Pass {
			...
			#include "My Lighting_Bloom.cginc"
		...
		Pass {
			...
			#include "My Shadows_Bloom.cginc"
		...
		Pass {
			...
			#include "My Lightmapping_Bloom.cginc"

			ENDCG
		}
	}

	CustomEditor "MyLightingShaderGUI_Bloom"
}