Shader "Custom/My First Lighting Shader_FXAA" {
...
//	#define PARALLAX_RAYMARCHING_SEARCH_STEPS 3
	...
	SubShader {
		...
		Pass {
			...
			#include "My Lighting_FXAA.cginc"
		...
		Pass {
			...
			#include "My Lightmapping_FXAA.cginc"

			ENDCG
		}
	}

	CustomEditor "MyLightingShaderGUI_FXAA"
}