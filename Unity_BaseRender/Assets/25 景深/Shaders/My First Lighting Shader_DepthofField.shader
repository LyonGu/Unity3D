Shader "Custom/My First Lighting Shader_DepthofField" {
...
//	#define PARALLAX_RAYMARCHING_SEARCH_STEPS 3
	...
	SubShader {
		...
		Pass {
			...
			#include "My Lighting_DepthofField.cginc"
		...
		Pass {
			...
			#include "My Shadows_DepthofField.cginc"
		...
		Pass {
			...
			#include "My Lightmapping_DepthofField.cginc"

			ENDCG
		}
	}

	CustomEditor "MyLightingShaderGUI_DepthofField"
}