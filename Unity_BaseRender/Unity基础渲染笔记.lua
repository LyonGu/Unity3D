...
17***************混合光照：烘焙光和实时光，项目里用的最多,支持实时阴影
{
	...
	2 使用阴影遮罩Shadowmask： LightingMode设置为shadowmask, 会比Baked Indirect效率高 ==》 将阴影烘焙到光照贴图中
	{
		...
		=-==》 之前的版本还有shadowDistance模式，最大阴影距离以内的使用实时阴影，并使用超出此范围的烘焙阴影
		==》 “Shadowmask” 与 距离模式完全相同，但Unity会为使用阴影遮罩的灯光省略静态阴影投射器。
