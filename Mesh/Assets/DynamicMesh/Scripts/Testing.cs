...
public class Testing : MonoBehaviour {
    ...
    private void CreateBasicQuadMesh() {
        ...
        vertices[0] = new Vector3(  0,   0); //左下
        vertices[1] = new Vector3(  0, 100); //左上
        vertices[2] = new Vector3(100, 100); //右上
        vertices[3] = new Vector3(100,   0); //右下

        uv[0] = new Vector2(0, 0); //跟顶点一一对应
    ...
    private void CreateTileMesh() {
        ...
        for (int i = 0; i < width; i++) {
            for (int j = 0; j < height; j++) {
                ...
                vertices[index * 4 + 0] = new Vector3(tileSize * i,         tileSize * j); //左下
                vertices[index * 4 + 1] = new Vector3(tileSize * i,         tileSize * (j + 1)); //左上
                vertices[index * 4 + 2] = new Vector3(tileSize * (i + 1),   tileSize * (j + 1)); //右上
                vertices[index * 4 + 3] = new Vector3(tileSize * (i + 1),   tileSize * j); //右下
