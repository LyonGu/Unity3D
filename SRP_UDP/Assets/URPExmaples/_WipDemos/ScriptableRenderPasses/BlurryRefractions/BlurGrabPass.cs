...
public class BlurGrabPass : UnityEngine.Rendering.Universal.ScriptableRendererFeature
{
    ...
    private GrabPassImpl_EX m_grabPass;

    public override void Create()
    {
        m_grabPass = new GrabPassImpl_EX(m_BlurMaterial, currentBlurAmount, m_BasicBlitMaterial);
...
public class GrabPassImpl_EX : UnityEngine.Rendering.Universal.ScriptableRenderPass
{
    ...
    public GrabPassImpl_EX(Material blurMaterial, Vector2 blurAmount, Material blitMaterial)
    {
