...
namespace XLua
{
    public partial class DelegateBridge : DelegateBridgeBase
    {
		...
		public int __Gen_Delegate_Imp13(int p0, int p1)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp16(int p0, int p1, int p2)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public override Delegate GetDelegateByType(Type type)
		{
			...
			{
			    return new CallLuaFunctionByDele.delAddingMutilReturn(__Gen_Delegate_Imp0);
			}
		
		    if (type == typeof(CallLuaFunctionByDele.delAddingMutilRetRef))
			{
			    return new CallLuaFunctionByDele.delAddingMutilRetRef(__Gen_Delegate_Imp1);
			}
		
		    if (type == typeof(XluaCallCSharpClass.MyDelegate))
			{
			    return new XluaCallCSharpClass.MyDelegate(__Gen_Delegate_Imp2);
			}
			...
			{
			    return new System.Func<int, int, int>(__Gen_Delegate_Imp13);
			}
			...
			{
			    return new System.Action<int, int, int>(__Gen_Delegate_Imp16);
			}
