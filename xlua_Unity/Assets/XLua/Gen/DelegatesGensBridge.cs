...
namespace XLua
{
    public partial class DelegateBridge : DelegateBridgeBase
    {
		...
		public void __Gen_Delegate_Imp6(int p0, int p1, int p2)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public InvokeLua.ICalc __Gen_Delegate_Imp16(int p0, string[] p1)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public override Delegate GetDelegateByType(Type type)
		{
			...
			{
			    return new System.Action<int, int, int>(__Gen_Delegate_Imp6);
			}
		    ...
		    if (type == typeof(CallLuaFunctionByDele.delAddingMutilReturn))
			{
			    return new CallLuaFunctionByDele.delAddingMutilReturn(__Gen_Delegate_Imp13);
			}
		
		    if (type == typeof(CallLuaFunctionByDele.delAddingMutilRetRef))
			{
			    return new CallLuaFunctionByDele.delAddingMutilRetRef(__Gen_Delegate_Imp14);
			}
		
		    if (type == typeof(XluaCallCSharpClass.MyDelegate))
			{
			    return new XluaCallCSharpClass.MyDelegate(__Gen_Delegate_Imp15);
			}
		
		    if (type == typeof(InvokeLua.CalcNew))
			{
			    return new InvokeLua.CalcNew(__Gen_Delegate_Imp16);
			}
