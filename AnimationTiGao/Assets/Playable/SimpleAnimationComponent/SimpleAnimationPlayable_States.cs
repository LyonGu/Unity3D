...
public partial class SimpleAnimationPlayable : PlayableBehaviour
{
    ...
    {
        public StateHandle(SimpleAnimationPlayable s, int index, Playable targetPlayable)
        {
            m_Parent = s;
            m_Index = index;
            m_TargetPlayable = targetPlayable; //其实就是stateInof结构上playable属性，一个AnimationClipPlayable
        }

        public bool IsValid()
        {
            return m_Parent.ValidateInput(m_Index, m_TargetPlayable);
        }
        ...
        private SimpleAnimationPlayable m_Parent; //自定义playableBehavior
        private int m_Index;
        private Playable m_TargetPlayable;
    }

    
    //原子层数据结构 StateInfo里包含一个playable
    private class StateInfo
    {
        ...
        public void Enable()
        {
            ...
            m_EnabledDirty = true; //m_Enabled发生变化的标记
            m_Enabled = true;
        }
...
//                m_Playable.GetGraph().DestroyPlayable(m_Playable);
        ...
        {
            //参数playable其实就是一个AnimationClipPlayable
            m_Playable = playable;
        }
        ...
        public StateHandle ParentStateHandle
        {
            get { return m_ParentStateHandle; }
        }

        public StateHandle m_ParentStateHandle;
    ...
    private class StateManagement
    {
        ...
        public bool IsCloneOf(int potentialCloneIndex, int originalIndex)
        {
            ...
            return potentialClone.isClone && potentialClone.ParentStateHandle.index == originalIndex;
        }
