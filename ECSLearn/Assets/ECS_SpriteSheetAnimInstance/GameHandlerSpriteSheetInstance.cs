...
public class GameHandlerSpriteSheetInstance : MonoBehaviour {

    private static GameHandlerSpriteSheetInstance instance;

    public static GameHandlerSpriteSheetInstance GetInstance() {
        return instance;
    }
