...
public class SpriteSheetRenderer_Basic : ComponentSystem {
    ...
    protected override void OnUpdate() {
        ...
        Mesh quadMesh = GameHandlerSpriteSheetInstance.GetInstance().quadMesh;
        Material material = GameHandlerSpriteSheetInstance.GetInstance().walkingSpriteSheetMaterial;
