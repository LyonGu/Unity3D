...
public class Box : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            Wayfinding();
            rigid.isKinematic = false; // 接受动力学模拟
        }
        else
            rigid.isKinematic = true; // 不接受动力学模拟
    }
    ...
    void Wayfinding() //寻路
    {
        ...
        //transform.Translate(0, 0, moveSpeed * Time.deltaTime);  //基本上是匀速


        //使用插值的形式  
        //Vector3 or = transform.position;
        //tt += moveSpeed * Time.deltaTime * 0.002f;
        //or = Vector3.Lerp(or, pos, tt);
