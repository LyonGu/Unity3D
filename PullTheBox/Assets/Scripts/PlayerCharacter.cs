...
public class PlayerCharacter : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        {
            h.GetComponent<MeshRenderer>().material.color = Color.black;
        }
    }
    ...
    public void Move(float x, float z) //移动方法
    {
        ...
        rigid.velocity = new Vector3(x, rigid.velocity.y, z);  //给刚体一个速度
    }
    ...
    public void PickUp() //拿起箱子
    {
        ...
        if (box) 
        {
            ...
            box.position = Vector3.MoveTowards(box.position, pos, Time.deltaTime * pullSpeed); //插值位置点
